            ...
            <tr>
                <td align="center" valign="top">
                    ...
                    <table width="640" cellpadding="0" cellspacing="0" border="0" class="wrapper">
                        <tr>
                            <td height="10" style="font-size:14px; line-height:10px;">&nbsp;</td>
                        </tr>
                        <tr>
                            <td align="center" valign="top">
                    ...
                    <table width="640" cellpadding="0" cellspacing="0" border="0" class="wrapper"
                        bgcolor="#FFFFFF" style="border-top-left-radius: 1rem;border-top-right-radius: 1rem;">
                        <tr>
                            <td height="10" style="font-size:14px; line-height:2rem;">
                                <br>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" valign="top">
                                <table width="600" border="0" class="container-text"
                                    style="font-size: 12px !important">
                                    <tr>
                                        <td align="left" valign="top">
                                            <p
                                                style="padding-bottom:10p;color:black;line-height: 1.5rem;font-size: 24px !important">
                                                Dear {{ $data->full_name }}
                                            </p>
                                            ...
                                            <p style="color:black;line-height: 1.5rem;font-size: 18px !important">
                                                ...
                                                yang telah Anda ikuti pada posisi {{ $data->position }}. Dengan menyesal
                                                kami memberi tahu Anda bahwa kami tidak dapat melanjutkan proses
                                                rekrutmen
                                                Anda untuk posisi ini. Proses seleksi sangat kompetitif dan kami
                                                memutuskan untuk memilih kandidat dengan kualifikasi yang paling sesuai
                                                dengan kebutuhan kami saat ini.
                                            </p>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <td class="img"
                                                                    ...
                                                                    <a href="https://www.facebook.com/sca.sda/"
                                                                        target="https://www.facebook.com/sca.sda/"><img
                                                                            ...
                                                                            border="0" alt="" /></a>
                                                                    <a href="https://www.instagram.com/scma.id/"
                                                                        target="https://www.instagram.com/scma.id/"><img
                                                                    ...
                                                                    <a href="https://id.linkedin.com/company/pt-sinar-cemaramas-abadi"
                                                                        target="https://id.linkedin.com/company/pt-sinar-cemaramas-abadi"><img
                                                ...
                                                <tr>
                                                    <td class="text-footer2 pb20"
                                                        style="color:#999999; font-family:'Lato', Arial,sans-serif; font-size:16px; line-height:26px; text-align:center; padding-bottom:20px;">
                                                        <div mc:edit="text_45">Pakuwon Tower Lt. 21, Unit 17-18, Kota
                                                            Surabaya, Indonesia 60261</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-footer2"
                                                        style="color:#999999; font-family:'Lato', Arial,sans-serif; font-size:16px; line-height:26px; text-align:center;">
                                                        <img src="https://recruitment.ptscma.co.id/img/favicon.png"
                                                            style="margin:0; padding:0; border:none; display:inline;width: 100px !important;"

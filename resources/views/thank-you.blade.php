            ...
            <tr>
                <td align="center" valign="top">
                    ...
                    <table width="640" cellpadding="0" cellspacing="0" border="0" class="wrapper"
                        ...
                        <tr>
                            <td height="10" style="font-size:10px; line-height:2rem;">
                                <br>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table width="600" border="0" class="container-text">
                                    <tr>
                                        <td align="left" valign="top">
                                            <p style="color:black;line-height: 1.5rem;font-size: 24px !important">
                                                Dear {{ $data->full_name }}
                                            </p>
                                            <p style="color:black;line-height: 1.5rem;font-size: 18px !important">
                                                Terima kasih telah melamar posisi {{ $data->position }} di PT. Sinar
                                                Cemaramas Abadi.
                                            </p>
                                            <p style="color:black;line-height: 1.5rem;font-size: 18px !important">
                                                Kami senang atas antusias Anda untuk bergabung dan berkarir bersama
                                                kami. Kami akan meninjau lamaran Anda dengan hati-hati. Hanya kandidat
                                                terpilih yang akan dihubungi oleh Tim Rekrutmen kami baik melalui WA /
                                                email untuk langkah selanjutnya!
                                            </p>
                                            ...
                                            <p style="color:black;line-height: 1.5rem;font-size: 18px !important">
                                                Sekali lagi terima kasih atas kesabaran dan minat Anda untuk bergabung
                                                dengan tim kami!
                                            </p>
                                    ...
                                    <tr>
                                        <td style="color: red">** Harap diperhatikan: Jangan balas email ini. Email ini
                                            dikirim dari kotak surat tanpa pengawasan dan balasan tidak dipantau.</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>

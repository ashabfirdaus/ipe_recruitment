...
var resDataTable = $('#dataTable').DataTable({
	...
	language: {
		...
		processing: "<img src='" + baseUrl + "/img/load-magic.gif' style='z-index:10000 !important;'>"
	},
...
$('.dataTables_filter').after('<div style="float:left;padding-left:10px;"><a href="javascript:void(0)" class="btn btn-default btn-show-filter"><i class="icon-filter4 position-left"></i> Filter</a></div>')
	...
	let data = [{
		...
		createdCell: function (td, cellData, rowData, row, col) {
			if (configMenu.activity.indexOf('edit') > -1 && editable) {
				$(td).html('<a class="me" href="' + currentUrl + '/entry/' + rowData.id + '" ><b>' + cellData + '</b></a>')
			} else {
